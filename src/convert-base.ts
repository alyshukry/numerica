 ...
 * @param {number} [precision=10] - The maximum number of digits to include after the decimal point when converting fractional values.
 * 
...
export function convertBase(n: number | string, to: number, from: number = 10, precision: number = 8): string {
